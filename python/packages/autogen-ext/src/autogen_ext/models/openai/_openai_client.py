...
class LogHandler(logging.FileHandler):
    ...
    def emit(self, record: logging.LogRecord) -> None:
        ...
        try:
            ...
            # # ---- CASE 2: Other structured autogen events ----
...
class BaseOpenAIChatCompletionClient(ChatCompletionClient):
    ...
    # ) -> CreateResult:
    #     ##### PALAK (new create method)
    #     from .palaks_poisson_dispatcher import PALAK_QUEUE, RequestItem, ensure_dispatcher, enqueue_request
    #     from datetime import datetime, timezone
    #     print("PALAK: inside new_create method")
    ...
    #     async def send():
    #         ts_send = datetime.now(timezone.utc).isoformat(timespec="microseconds")
    #         print(f"PALAK: IMPORTANT: [{ts_send}] SENT REQUEST: {custom_request_id}")
    ...
    #     likely_good_tasks = {"ec09fa32-d03f-4bf8-84b0-1f16922c3ae4", "5d0080cb-90d7-4712-bc33-848150e917d3", "a1e91b78-d3d8-4675-bb8d-62741b4b68a6", "2d83110e-a098-4ebb-9987-066c06fa42d0", "27d5d136-8563-469e-92bf-fd103c28b57c", "dc28cf18-6431-458b-83ef-64b3ce566c10", "5188369a-3bbe-43d8-8b94-11558f909a08", "6f37996b-2ac7-44b0-8e68-6d28256631b4", "a3fbeb63-0e8c-4a11-bff6-0e3b484c3e9c", "c714ab3a-da30-4603-bacd-d008800188b9", "cabe07ed-9eca-40ea-8ead-410ef5e83f91", "f918266a-b3e0-4914-865d-4faa564f1aef", "11af4e1a-5f45-467d-9aeb-46f4bb0bf034", "bda648d7-d618-4883-88f4-3466eabd860e", "50ec8903-b81f-4257-9450-1085afd2c319", "cf106601-ab4f-4af9-b045-5295fe67b37d", "7bd855d8-463d-4ed5-93ca-5fe35145f733"} ##### fill this set TODO


    #     # task_id_from_request_id = custom_request_id.split(':')[0].split('_')[-1]
    ...
    #     # likely_success = any(good_id in task_id_from_request_id for good_id in likely_good_tasks)
    #     likely_success = task_id_from_request_id in likely_good_tasks
    #     # likely_success = True #### all same priority
    #     await enqueue_request(
    #         send=send,
    #         future=response_future,
    #         request_id=custom_request_id,
    #         is_high_priority=likely_success,  # True or False
    #     )
    ...
    #     result: Union[ParsedChatCompletion[BaseModel], ChatCompletion] = await response_future
    #     if create_params.response_format is not None:
    ...
    async def create(
        ...
        *,
        ...
        async def send():
            from datetime import datetime, timezone
            ts = datetime.now(timezone.utc).isoformat(timespec="microseconds")
            print(f"PALAK: IMPORTANT: [{ts}] SENT REQUEST: {custom_request_id}")
        ...
        likely_good_tasks = {"ec09fa32-d03f-4bf8-84b0-1f16922c3ae4", "5d0080cb-90d7-4712-bc33-848150e917d3", "a1e91b78-d3d8-4675-bb8d-62741b4b68a6", "2d83110e-a098-4ebb-9987-066c06fa42d0", "27d5d136-8563-469e-92bf-fd103c28b57c", "dc28cf18-6431-458b-83ef-64b3ce566c10", "5188369a-3bbe-43d8-8b94-11558f909a08", "6f37996b-2ac7-44b0-8e68-6d28256631b4", "a3fbeb63-0e8c-4a11-bff6-0e3b484c3e9c", "c714ab3a-da30-4603-bacd-d008800188b9", "cabe07ed-9eca-40ea-8ead-410ef5e83f91", "f918266a-b3e0-4914-865d-4faa564f1aef", "11af4e1a-5f45-467d-9aeb-46f4bb0bf034", "bda648d7-d618-4883-88f4-3466eabd860e", "50ec8903-b81f-4257-9450-1085afd2c319", "cf106601-ab4f-4af9-b045-5295fe67b37d", "7bd855d8-463d-4ed5-93ca-5fe35145f733"}
        ...
        await enqueue_request(
            ...
            future=future,
            request_id=custom_request_id,
            is_high_priority=likely_success,
        )
