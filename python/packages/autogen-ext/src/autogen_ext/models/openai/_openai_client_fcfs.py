...
#     PALAK_JUDGE_HISTORY = {}
#     PALAK_JUDGE_LAST_PRIORITY = {}   # task_id -> int
...
#         #     # Only shift after 5 consecutive Incorrect predictions
#         #     consecutive = 0
...
#         task_priority = 1
#         if latest_judge is None or step_count <= 10:
#             task_priority = 1
#         else:
#             # Count consecutive Incorrect from the end
#             consecutive_incorrect = 0
#             for pred in reversed(judge_history):
#                 if pred == "Incorrect":
...
#                 task_priority = 2
#             else:
#                 # In transition — hold previous priority
#                 task_priority = BaseOpenAIChatCompletionClient.PALAK_JUDGE_LAST_PRIORITY.get(task_id, 2)

#         BaseOpenAIChatCompletionClient.PALAK_JUDGE_LAST_PRIORITY[task_id] = task_priority

#         print(f"[{task_id}] step={step_count} judge={latest_judge} "
#             f"consec_incorrect={consecutive_incorrect} consec_correct={consecutive_correct} "
#             f"final_priority={task_priority}")
